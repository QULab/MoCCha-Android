...
public class PropertiesProvider {
   ...
   */
  public static final String PROPERTY_FILE = "moccha.properties";
  
  /**
   * The property which should contains the url
   * for downloading the canteens content.
   */
  public static final String CANTEENS_URL_PROP = "canteens.url";
